...
**Response**: Gentoo penguins have the largest flipper length on average, Adelie have the smallest.
...
**Response**: The boxplot lets you see defined summary statistics, while a jitterplot lets you see the spread of points visually
...
**Response**: The knit file is easier to read than the file in GitHub, as we can see pictures and links and such.
...
**Response**: The jitterplot on top of the boxplot to see all of th points
...
**Response**: I think species is the variable that explains the most to the two peaks
